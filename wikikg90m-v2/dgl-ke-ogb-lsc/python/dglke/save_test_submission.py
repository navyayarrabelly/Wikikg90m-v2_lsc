...
if __name__ == '__main__':
    path = "/mnt/data/ogbl_wikikg2_recent/ogbl_wikikg2/smore_folder_full/saved_models/TransE_l2_wikikg90m_shallow_d_600_g_10.00"
    num_proc = 1
    mode = "test-dev"
    with_test = True

    valid_candidate_path = "/mnt/data/ogbl_wikikg2_recent/ogbl_wikikg2/smore_folder_full/wikikg90m-v2/processed/val_t_candidate.npy"
    test_candidate_path = "/mnt/data/ogbl_wikikg2_recent/ogbl_wikikg2/smore_folder_full/wikikg90m-v2/processed/test_t_candidate.npy"

    get_test_predictions(path,valid_candidate_path,test_candidate_path,"test-dev",1) 
